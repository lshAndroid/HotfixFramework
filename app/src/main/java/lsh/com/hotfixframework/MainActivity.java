package lsh.com.hotfixframework;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCurrentVersion.setText("当前版本热修复包1：" + getCurrentVersion(this));

        //1.基准包:当前版本基准包:
        //2.修复包:当前版本热修复包1  使用:gradle.properties PATCH_PATH APK_NAME
        //3.修复包:当前版本热修复包2  使用:gradle.properties PATCH_PATH APK_NAME
        //4.修复包:当前版本热修复包3  使用:gradle.properties PATCH_PATH APK_NAME
    }
